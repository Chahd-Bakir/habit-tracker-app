  ...
  <AdminLayout>
    <template #header>
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-lg font-semibold text-slate-900">Habit Categories</h1>
          <p class="text-sm text-slate-500">Organise suggestions by category</p>
        </div>
        <button @click="openCreate" class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 transition">+ New category</button>
      </div>
    </template>
